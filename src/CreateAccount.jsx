    ...
    <>
     <div className='grid gap-10 md:grid-cols-2 min-h-screen '>
         ...
         <div className='  flex flex-col ml-6.5 w-[85%] my-8'>             {/* login grid part */}
          ...
          <SocialLogin page="Create Account" instructions="Follow the instructions to make it easier to register and you will be able to explore inside."/>
          ...
          <InputField type="text" placeholder="320-9456-12" label="Referral Code (Optional)"/>
             ...
             <div>
             <Link to="/EmailVerification"> <Button buttonname="Create Account"/></Link>
             </div>
