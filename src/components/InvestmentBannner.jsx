...
const InvestmentBanner = ({ heading, heading2, paragrapgh, buttonname }) => {
  return (
    <div className="flex  justify-center items-center py-10 mb-[-22%] lg:mb-[-20%] xl:mb-[-18%] 2xl:mb-[-12%]">
      <div className="relative bg-[#0D2A52] text-white px-10 py-8 w-[1120px] rounded shadow-lg">
        ...
        <div className="flex justify-between items-center relative z-10">
          <div>
            <h2 className="text-2xl font-bold mb-2">Looking for a dream Investment?</h2>
            <p className="text-sm">We can help you realize your dream of a new home</p>
          </div>
