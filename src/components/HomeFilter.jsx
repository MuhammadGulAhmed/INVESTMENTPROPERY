...
function HomeFilter({ page }) {
  ...
  return (
    <div className="h-[37.5rem] box-border w-[84.3rem] overflow-hidden flex flex-col gap-7 bg-cover bg-center bg-[url(/main-bg.png)]">
      {/* Header Top Bar */}
      <div className="h-[2rem] flex justify-evenly overflow-hidden items-center border-b border-[#FFFFFF1A]">
